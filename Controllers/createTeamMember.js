...
exports.createTeamMember = async (req, res) => {
    try {
        console.log(`[URL: ${JSON.stringify(req.body)}] [START: ${Date.now()}]`);
        ...
        let message = Message.CREATE_SUCCESS;
        return SendResponse.sendSuccessData(res, {userId: 123}, message);
    } catch (error) {
        console.error(`[ERROR:${error}]`);

        return SendResponse.sendSuccessData(res, {userId: 456});
